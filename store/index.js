export const state = () => ({
  ...
  socialLinks: [
    {
      icon: "mdi-linkedin",
      link: "https://www.linkedin.com/in/franklinkemta",
    },
    {
      icon: "mdi-github",
  ...
  profiles: {
    fullstack_eng: {
      ...
      statusText:
        "Fullstack Software Engineer <br>Graduated in Computer Science and IT Project Management",
      cssClass: "",
      skills: [
        {
          name: "Python",
    ...
    workspace_tools: {
      ...
      statusText:
        "Focused on increasing UX in products by bringing soft and hardwares systems to life using AI, ML, CV and analytics",
      cssClass: "",
      skills: [
        {
          name: "Docker",
